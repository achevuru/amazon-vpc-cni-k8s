...
func New(k8sapiClient kubernetes.Interface, eniConfig *eniconfig.ENIConfigController) (*IPAMContext, error) {
	...
	client, err := awsutils.New(c.useCustomNetworking, c.enablePrefixDelegation, c.enableIPv4, c.enableIPv6)
	if err != nil {
...
func (c *IPAMContext) nodeInit() error {
	...
	*/
	...
	if err = c.configureIPRulesForPods(vpcV4CIDRs); err != nil {
		return err
	}
	...
	if !c.enableIPv6 && c.useCustomNetworking && c.eniConfig.Getter().MyENI != "default" {
	...
	// SGPP isn't currently supported in IPv6 mode.
	if !c.enableIPv6 {
...
func usePrefixDelegation() bool {
	return getEnvBoolWithDefault(envEnablePrefixDelegation, false)
}
...
func (c *IPAMContext) warmPrefixTargetDefined() bool {
	return c.warmPrefixTarget >= noWarmPrefixTarget && c.enablePrefixDelegation
}
